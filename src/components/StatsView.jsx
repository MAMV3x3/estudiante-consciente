...
const StatsView = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto">
            <div className="mb-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-2">Tu Progreso Emocional</h2>
                <p className="text-gray-600">Analiza tu bienestar y patrones de comportamiento</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl p-6 shadow-lg">
                    ...
                    <div className="text-3xl font-bold mb-1">{totalMoods}</div>
                    <div className="text-blue-100">Registros de Ánimo</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-teal-500 to-teal-600 text-white rounded-xl p-6 shadow-lg">
                    ...
                    <div className="text-3xl font-bold mb-1">{weeklyCompletionRate}%</div>
                    <div className="text-teal-100">Hábitos esta Semana</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-xl p-6 shadow-lg">
                    ...
                    <div className="text-purple-100">Estado Más Frecuente</div>
                </div>
            </div>

            {/* Mood Distribution */}
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 mb-8">
                <h3 className="text-xl font-bold text-gray-900 mb-6">Distribución de Estados de Ánimo</h3>
                {totalMoods === 0 ? (
                    <p className="text-gray-500 text-center py-8">Aún no has registrado estados de ánimo.</p>
                ) : (
                            ...
                            return (
                                <div key={moodId}>
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="font-medium text-gray-700">{moodLabels[moodId]}</span>
                                        <span className="text-sm text-gray-600">{count} veces ({percentage}%)</span>
                                    </div>
                    ...
                    {weeklyHabitData.map((day, index) => {
                        ...
                        return (
                            <div key={index} className="text-center">
                                <div className="text-xs text-gray-500 mb-2 capitalize">{dayName}</div>
                                <div
